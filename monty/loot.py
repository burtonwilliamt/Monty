...
LOOT_BOXES = {
    LootBoxType.TRASH_BAG: [
        ...
        LootItem(
            ...
            name='Dog poop',
            desc=
            'This bag has a hole in it. Gross, now you have to replace your gloves.',
            value=-1.0,
            rarity=Rarity.RARE,
        ),
        LootItem(
...
class ItemGenerator:
    ...
    def __init__(self, user: discord.User, money: money_db.MoneyDatabase,
                 items: list[LootItem]):
        self.user = user
        self.money = money
    ...
    def _choose_rarity_class(self) -> Rarity:
        ...
        rarity_weights = [
            RARITY_WEIGHTS[r] for r in rarity_classes_in_this_generator
        ]
        return random.choices(rarity_classes_in_this_generator,
                              rarity_weights)[0]
...
async def create_lootbox_opener(interaction: discord.Interaction,
